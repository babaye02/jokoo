...
[Trouvez une baby-sitter](/#family) sur Jokoo Family.
    `.trim()}];function e(a){return d.find(b=>b.slug===a)||null}},83285:(a,b,c)=>{c.r(b),c.d(b,{default:()=>m,generateMetadata:()=>l,generateStaticParams:()=>k});var d=c(75338),e=c(65169),f=c.n(e),g=c(82161),h=c(77373),i=c(88261),j=c(82513);async function k(){return j.M.map(a=>({slug:a.slug}))}async function l({params:a}){let{slug:b}=await a,c=(0,j.f)(b);return c?{title:`${c.title} \xb7 Blog Jokoo`,description:c.description,openGraph:{title:c.title,description:c.description,type:"article",publishedTime:c.date}}:{title:"Article introuvable"}}async function m({params:a}){let{slug:b}=await a,c=(0,j.f)(b);c||(0,g.notFound)();let e=j.M.filter(a=>a.slug!==c.slug).slice(0,2);return(0,d.jsx)(d.Fragment,{children:(0,d.jsxs)("article",{className:"bg-white",children:[(0,d.jsx)("div",{className:"bg-gradient-to-br from-midnight to-midnight-dark text-white py-14",children:(0,d.jsxs)("div",{className:"max-w-3xl mx-auto px-6",children:[(0,d.jsx)(f(),{href:"/blog",className:"inline-flex items-center gap-2 text-white/70 hover:text-turquoise text-sm mb-6 transition",children:"← Retour au blog"}),(0,d.jsxs)("div",{className:"flex items-center gap-3 text-xs",children:[(0,d.jsx)("span",{className:"px-3 py-1 rounded-full font-bold bg-turquoise/20 text-turquoise",children:c.category}),(0,d.jsx)("span",{className:"text-white/60",children:new Date(c.date).toLocaleDateString("fr-FR",{day:"numeric",month:"long",year:"numeric"})}),(0,d.jsxs)("span",{className:"text-white/60",children:["\xb7 ",c.readingTime]})]}),(0,d.jsx)("h1",{className:"mt-5 text-3xl md:text-5xl font-black leading-tight",children:c.title}),(0,d.jsx)("p",{className:"mt-4 text-white/80 text-lg",children:c.description})]})}),(0,d.jsxs)("div",{className:"max-w-3xl mx-auto px-6 py-14",children:[(0,d.jsx)("div",{className:"aspect-[16/8] rounded-3xl bg-gradient-to-br from-turquoise/10 to-midnight/10 flex items-center justify-center text-9xl mb-10",children:c.cover}),(0,d.jsx)("div",{className:"prose prose-lg",children:(0,d.jsx)(h.o,{remarkPlugins:[i.A],children:c.content})})]}),e.length>0&&(0,d.jsx)("div",{className:"max-w-5xl mx-auto px-6 pb-24",children:(0,d.jsxs)("div",{className:"border-t border-gray-100 pt-12",children:[(0,d.jsx)("h2",{className:"text-2xl font-black text-midnight mb-8",children:"Continuez \xe0 lire"}),(0,d.jsx)("div",{className:"grid md:grid-cols-2 gap-6",children:e.map(a=>(0,d.jsxs)(f(),{href:`/blog/${a.slug}`,className:"group rounded-3xl overflow-hidden border border-gray-100 hover:border-turquoise hover:shadow-md transition bg-white",children:[(0,d.jsx)("div",{className:"aspect-[16/9] bg-gradient-to-br from-turquoise/10 to-midnight/10 flex items-center justify-center text-7xl",children:a.cover}),(0,d.jsxs)("div",{className:"p-5",children:[(0,d.jsx)("h3",{className:"font-black text-midnight group-hover:text-turquoise transition",children:a.title}),(0,d.jsx)("div",{className:"mt-2 text-sm text-gray-500",children:a.readingTime})]})]},a.slug))})]})})]})})}},86439:a=>{a.exports=require("next/dist/shared/lib/no-fallback-error.external")}};var b=require("../../../webpack-runtime.js");b.C(a);var c=b.X(0,[124,210,665,603],()=>b(b.s=31123));module.exports=c})();